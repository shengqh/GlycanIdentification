...
public class BranchFragmentationBuilderImpl implements FragmentationBuilder<Peak> {
	...
	public BranchFragmentationBuilderImpl(IMassProxy massProxy) {
		super();
	...
	public PeakList<Peak> build(Glycan glycan) {
		...
		List<IMonosaccharide> oss = glycan.getOligosaccharidesFromReducingTerm();
