...
public class GlycanImageLeaf2RootBuilderTest extends TestCase {
	public void testDraw() throws Exception {
		GlycanImageLeaf2RootBuilder builder = new GlycanImageLeaf2RootBuilder();
		...
		FileOutputStream fos = new FileOutputStream("c:\\temp_l2r.png");
